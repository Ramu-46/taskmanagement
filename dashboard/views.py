...
def load_employees(request):
    """
    Optional AJAX view to load employees under a specific manager.
    Call this dynamically from JS if needed.
    """
    manager_id = request.GET.get('manager_id')
    if manager_id:
        employees = Profile.objects.filter(role='employee', manager__id=manager_id)
